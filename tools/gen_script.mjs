...
const shape = isText
  ...
  : `{"hook":"экранный хук-фраза","script":"устный монолог под длину площадки, начни с хука, сохрани продукт; В КОНЦЕ устно скажи, ГДЕ искать ссылку","ctaTitle":"короткий призыв к действию, 2 строки через \\n — БЕЗ слов о том, где ссылка"}`;
...
const system =
  ...
  ` ${isText ? "Это ТЕКСТОВЫЙ пост." : "Это видео с реальным человеком (озвучка). Где искать ссылку — говори ТОЛЬКО в устном тексте (script), НЕ в ctaTitle."} ` +
